...
<div class="request-status-index">
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            'id',
            'follow_up_date',
            //['attribute'=>'follow_up_date','format'=>['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']],
            'followed_up_by_id',
            'notes:ntext',
